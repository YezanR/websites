				...
				<div class="contact-form">
					...
					<?php if(isset($has_error)) { ?>
						...
						<div class="row">
							...
							<div class="one-half">	
								<div class="field">
									<label for="sender_name"><?php _e('Nom', 'fairpixels') ?><span class="required"><?php _e('Obligatoire', 'fairpixels') ?></span></label>
									<input type="text" class="text name_field requiredField" name="sender_name" id="sender_name" placeholder="Votre nom et prénom" value="<?php if(isset($_POST['sender_name'])) echo $_POST['sender_name'];?>" />
									<?php if($name_error != '') { ?>
							...
							<div class="one-half last">
								<div class="field">
									<label for="sender_email"><?php _e('Email', 'fairpixels') ?><span class="required"><?php _e('Obligatoire', 'fairpixels') ?></span></label>
									<input type="text" class="text requiredField email" name="sender_email" id="sender_email" placeholder="Pour vous contacter" value="<?php if(isset($_POST['sender_email']))  echo $_POST['sender_email'];?>" />
									<?php if($email_error != '') { ?>
						...
						<div class="row">
							<div class="field message-field">
								<label for="message_title"><?php _e('Titre du message', 'fairpixels') ?><span class="required"><?php _e('Obligatoire', 'fairpixels') ?> </span></label>
								<input type="text" class="text title_field requiredField" name="message_title" id="message_title" placeholder="Votre sujet" value="<?php if(isset($_POST['message_title'])) echo $_POST['message_title'];?>" />
								<?php if($name_error != '') { ?>
						...
						<div class="row">
							<div class="field textarea-field">		
								<label for="message_text"><?php _e('Tapez votre message', 'fairpixels') ?><span class="required"><?php _e('Obligatoire', 'fairpixels') ?> </span></label>
								<textarea class="textarea message_field requiredField" name="message_text" id="message_text" placeholder="Votre message içi ..."><?php if(isset($_POST['message_text'])) { if(function_exists('stripslashes')) { echo stripslashes($_POST['message_text']); } else { echo $_POST['message_text']; } } ?></textarea>
						...
						<div class="row">
							<div class="field">
								<input type="submit" name="fp_submit" value="Envoyer le message" class="button main-color-bg" />
							</div>
						</div>					
				</form>
