...
function fp_custom_styles(){
	...
	if (!empty($fp_primary_color)){		
		...
		$fp_custom_style .= ".primary-menu ul li ul li a,\n .primary-menu ul li:hover ul li a,\n .primary-menu ul li.over ul li a,\n.pagination  .page-numbers,\n .tagcloud a{\n    background: ".$fp_primary_color." \n}\n\n";		
		$fp_custom_style .= ".primary-menu .menu-item-home a:hover{\n    background-color: ".$fp_primary_color." \n}\n\n";				
		$fp_custom_style .= "#header .social li{\n    border-left: none;\n border-left: 1px solid rgba(255, 255, 255, 0.1);\n border-right: none; \n}\n\n";	
		$fp_custom_style .= "#respond input[type=submit],\n .button{\n    box-shadow: none; \n}\n\n";	
	}
	...
	if (!empty($fp_second_color)){
		$fp_custom_style .= ".second-color{ \n    color: ".$fp_second_color." \n}\n\n";		
		$fp_custom_style .= ".second-color-bg,\n .cat-header .cat-title,\n .pagination a:hover,\n .pagination .current,\n #sidebar .widget .widget-title h4,\n .widget_tabs .active{ \n    background: ".$fp_second_color." \n}\n\n";
		$fp_custom_style .= ".cat-header,\n #sidebar .widget .widget-title,\n .archive-header{ \n    border-bottom: 2px solid ".$fp_second_color." \n}\n\n";		
	}
	
	//set third color
	$fp_third_color = $options['fp_third_color'];
	
	if (!empty($fp_third_color)){
		$fp_custom_style .= ".primary-menu,\n .widget_tabs .widget-tabs-title-container ul,\n #footer .footer-info { \n    background: ".$fp_third_color." \n}\n\n";
	}
