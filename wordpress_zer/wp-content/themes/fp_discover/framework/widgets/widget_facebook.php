<?php
/**
 * Plugin Name: FairPixels: Facebook Likebox
 ...
 */
add_action('widgets_init', 'fairpixels_facebook_widgets');

function fairpixels_facebook_widgets()
{
	register_widget('fairpixels_facebook_widget');
}
 ...
 *
 */
class fairpixels_facebook_widget extends WP_Widget {
	
	/**
	 * Widget setup.
	 */
	function fairpixels_facebook_widget()
	{
		/* Widget settings. */
		$widget_ops = array('classname' => 'widget_facebook', 'description' => 'Displays Facebook like box in the sidebar of the theme.');
		
		/* Create the widget. */
		$this->WP_Widget('fairpixels_facebook_widget', 'FairPixels: Facebook Likebox', $widget_ops);
	}
	...
	function form($instance)
	{
		...
		<p>
			<label for="<?php echo $this->get_field_id('page_url'); ?>"><?php _e('Facebook Page URL:', 'fairpixels') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('width'); ?>"><?php _e('Width:', 'fairpixels') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('color_scheme'); ?>"><?php _e('Color Scheme:', 'fairpixels') ?></label> 
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('show_faces'); ?>"><?php _e('Show faces', 'fairpixels') ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('show_stream'); ?>"><?php _e('Show stream', 'fairpixels') ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('show_header'); ?>"><?php _e('Show facebook header', 'fairpixels') ?></label>
		</p>
	<?php
	}
}
