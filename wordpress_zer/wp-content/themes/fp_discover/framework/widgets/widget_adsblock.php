<?php
/**
 * Plugin Name: FairPixels: 150x150 Ads Widget
 ...
 */
add_action( 'widgets_init', 'fairpixels_adsblock_widgets' );

function fairpixels_adsblock_widgets() {
	register_widget( 'fairpixels_adsblock_widget' );
}
 ...
 *
 */
class fairpixels_adsblock_widget extends WP_Widget {

	/**
	 * Widget setup.
	 */
	function fairpixels_adsblock_widget() {	
		
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'widget_adsblock', 'description' => __('This widget allows to place upto 4 ads block in sidebar.', 'fairpixels') );
		
		/* Create the widget. */
		$this->WP_Widget( 'fairpixels_adsblock_widget', __('FairPixels: 150x150px Ads Block', 'fairpixels'), $widget_ops );
	}
	...
	function form( $instance ) {
		...
		$defaults = array(
		'title' => 'Sponsors',
		'ad1' => get_template_directory_uri()."/images/ad150.png",
		'link1' => 'http://fairpixels.com',
		'ad2' => get_template_directory_uri()."/images/ad150.png",
		'link2' => 'http://fairpixels.com',
		'ad3' => '',
		'link3' => '',
		'ad4' => '',
		'link4' => '',		
		...
		<!-- ad1 image url input-->
		<p>
			<label for="<?php echo $this->get_field_id( 'ad1' ); ?>"><?php _e('Ad 1 image url:', 'fairpixels') ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'ad1' ); ?>" name="<?php echo $this->get_field_name( 'ad1' ); ?>" value="<?php echo $instance['ad1']; ?>" />
		</p>
		
		<!-- ad1 link url input -->
		<p>
			<label for="<?php echo $this->get_field_id( 'link1' ); ?>"><?php _e('Ad 1 link url:', 'fairpixels') ?></label>
		...
		<!-- ad2 image url input-->
		<p>
			<label for="<?php echo $this->get_field_id( 'ad2' ); ?>"><?php _e('Ad 2 image url:', 'fairpixels') ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'ad2' ); ?>" name="<?php echo $this->get_field_name( 'ad2' ); ?>" value="<?php echo $instance['ad2']; ?>" />
		</p>
		
		<!-- ad2 link url input -->
		<p>
			<label for="<?php echo $this->get_field_id( 'link2' ); ?>"><?php _e('Ad 2 link url:', 'fairpixels') ?></label>
		...
		<!-- ad3 image url input-->
		<p>
			<label for="<?php echo $this->get_field_id( 'ad3' ); ?>"><?php _e('Ad 3 image url:', 'fairpixels') ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'ad3' ); ?>" name="<?php echo $this->get_field_name( 'ad3' ); ?>" value="<?php echo $instance['ad3']; ?>" />
		</p>
		
		<!-- ad3 link url input -->
		<p>
			<label for="<?php echo $this->get_field_id( 'link3' ); ?>"><?php _e('Ad 3 link url:', 'fairpixels') ?></label>
		...
		<!-- ad4 image url input-->
		<p>
			<label for="<?php echo $this->get_field_id( 'ad4' ); ?>"><?php _e('Ad 4 image url:', 'fairpixels') ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'ad4' ); ?>" name="<?php echo $this->get_field_name( 'ad4' ); ?>" value="<?php echo $instance['ad4']; ?>" />
		</p>
		
		<!-- ad4 link url input -->
		<p>
			<label for="<?php echo $this->get_field_id( 'link4' ); ?>"><?php _e('Ad 4 link url:', 'fairpixels') ?></label>
